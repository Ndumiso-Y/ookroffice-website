    ...
    <div className="max-w-6xl mx-auto flex flex-col items-center space-y-6">
      ...
      <nav>
        <ul className="flex flex-wrap justify-center items-center gap-6 text-sm font-medium">
          <li><Link to="/" className="hover:text-[#c27700]">Home</Link></li>
          <li><Link to="/about" className="hover:text-[#c27700]">About</Link></li>
          <li><Link to="/heritage" className="hover:text-[#c27700]">Heritage</Link></li>
          <li><Link to="/events" className="hover:text-[#c27700]">Events</Link></li>
          {/* <li><Link to="/notices" className="hover:text-[#c27700]">Notices</Link></li> */}
          <li><Link to="/contact" className="hover:text-[#c27700]">Contact</Link></li>
        </ul>
      </nav>
