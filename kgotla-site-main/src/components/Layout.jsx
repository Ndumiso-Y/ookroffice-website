...
const Layout = ({ children }) => {
  ...
  return (
    <div className="relative min-h-screen bg-mustard text-black font-sans overflow-x-hidden">
      ...
      <div className="fixed top-0 left-0 w-72 h-72 bg-gold rounded-full opacity-10 blur-3xl z-[-1]" />
      <div className="fixed bottom-0 right-0 w-96 h-96 bg-gold rounded-full opacity-10 blur-3xl z-[-1]" />
