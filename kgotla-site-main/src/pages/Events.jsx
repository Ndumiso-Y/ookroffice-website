  ...
  const events = [
    {
      ...
      image: "/images/GlobalGovernanceSummit2025.jpg",
    },
    {
      day: "19",
      month: "Oct",
      ...
      image: "/images/10YearVisionImpactLekgotla.jpeg",
    },
  ];
      ...
      <div className="max-w-5xl mx-auto space-y-12 fade-in">
          ...
          {events.map((event, i) => (
            ...
            >
              ...
              <div className="ml-6 flex-1 space-y-1">
                <h4 className="text-lg font-semibold text-gold">{event.title}</h4>
        ...
        <div className="bg-forest text-white p-6 rounded-lg text-center">
          ...
          <a
            ...
            className="inline-block mt-4 bg-gold text-white px-4 py-2 rounded hover:bg-[#a25e00]"
          >
