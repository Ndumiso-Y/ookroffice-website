...
export default function Home() {
  ...
  const updates = [
    ...
    },
    {
      ...
      link: "/events",
      image: "/images/SOKA2025Event.png",
    },
    {
      day: "08",
      month: "Mar",
  ...
  return (
    <div className="home">
      {/* HERO SECTION */}
      <section className="relative bg-gradient-to-r from-forest to-gold text-white py-20 px-6 text-center">
        <div className="max-w-6xl mx-auto fade-in relative z-10 flex flex-col items-center">
          <img
            src="/images/KgosanaHome.jpg"
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 fade-in">
          <div className="flex-1">
            ...
            <Link
              to="/about"
              className="bg-gold text-white px-6 py-2 rounded hover:bg-[#a25e00] transition"
            >
              Discover Our Story
            </Link>
          </div>
          <div className="flex-1">
            <img
              src="/images/KgotlaLeadership.jpg"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <h3 className="font-semibold text-gold mb-2">{service.title}</h3>
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 fade-in">
          ...
          <div className="flex-1">
            ...
            <Link
              to="/heritage"
              className="mt-6 inline-block bg-gold text-white px-6 py-2 rounded hover:bg-[#a25e00] transition"
            >
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <h3 className="font-semibold text-gold">{update.title}</h3>
                  </div>
      ...
      {/* CALL TO ACTION */}
      <section className="bg-gradient-to-r from-forest to-gold text-white py-20 px-6 text-center">
