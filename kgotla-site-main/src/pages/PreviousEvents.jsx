...
export default function PreviousEvents() {
  ...
  const pastEvents = [
    {
      ...
      media: [
        { type: "image", src: "/images/medicare-basic-life-support-training.jpg" },
      ],
    },
    {
      date: "25 Nov 2025",
      ...
      media: [
        { type: "image", src: "/images/ethical-investment-breakfast.jpg" },
      ],
    },
    {
      date: "25 Nov 2025",
      ...
      media: [
        { type: "image", src: "/images/rorisang-exit-ceremony.jpg" },
      ],
    },
    {
      date: "22 Nov 2025",
      ...
      media: [
        { type: "image", src: "/images/township-economy-awards.jpg" },
      ],
    },
    {
      date: "17 Nov 2025",
      ...
      media: [
        { type: "image", src: "/images/ModernCEOBreakfast.jpg" },
      ],
    },
    {
      date: "13 Nov 2025",
      ...
      media: [
        { type: "image", src: "/images/ChristmasGiveaway.jpg" },
      ],
    },
    {
      date: "12 Nov 2025",
      ...
      media: [
        { type: "image", src: "/images/PublicHealthConference.jpg" },
      ],
    },
    {
      date: "15 Jan 2025",
      ...
      media: [
        {
          ...
          thumbnail: "/images/KgotlhaLogo.png",
        },
      ],
    },
    {
      ...
      media: [
        ...
        { type: "image", src: "/images/ExcellenceAwardsGraduates.jpg" },
        {
          ...
          thumbnail: "/images/ExcellenceAward.jpeg",
        },
      ],
    },
    {
      ...
      media: [
        ...
        { type: "image", src: "/images/SOKA25Kgosana.jpg" },
        {
          ...
          thumbnail: "/images/SOKA2025Event.png",
        },
      ],
    },
    {
      ...
      media: [
        { type: "image", src: "/images/DrKoketsoRakhuduChroniclesNight.jpeg" },
        {
          ...
          thumbnail: "/images/DrKoketsoRakhuduChroniclesNight.jpeg",
        },
      ],
    },
    {
  ...
  return (
    <div className="previous-events">
      {/* HERO */}
      <section className="bg-gradient-to-r from-forest to-gold text-white py-16 px-6 text-center">
          ...
          {sortedEvents.map((event, i) => (
            ...
            >
              ...
              <div className="mt-4 space-y-2">
                ...
                <h2 className="text-xl font-semibold text-gold">{event.title}</h2>
