      ...
      <section className="mb-12 bg-white p-6 rounded-lg shadow-lg relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
          ...
          <Link
            ...
            className={`inline-flex items-center justify-center gap-2 px-8 py-3 font-semibold rounded-lg shadow-md transition duration-200 transform hover:scale-105 ${
              divisionLinks.krf.enabled
                ? 'bg-blue-600 text-white hover:bg-blue-700 cursor-pointer'
                : 'bg-gray-400 text-gray-200 cursor-not-allowed opacity-60'
            }`}
            title={divisionLinks.krf.enabled ? 'Visit Foundation Website' : 'Website coming soon'}
            onClick={(e) => !divisionLinks.krf.enabled && e.preventDefault()}
          >
            <FaGlobe className="text-xl" />
            {divisionLinks.krf.enabled ? 'Visit Website' : 'Coming Soon'}
            {divisionLinks.krf.enabled && <FaExternalLinkAlt className="text-sm" />}
          </Link>
        </div>
      </section>
      ...
      <section className="mb-12 bg-gray-50 p-6 rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          <Link
            ...
            className="inline-block px-8 py-3 bg-[#1B5538] text-white font-semibold rounded-lg shadow-lg hover:bg-[#397D5A] transition duration-200"
          >
            Learn More
          </Link>
          <Link
            ...
            title={divisionLinks.coffee.enabled ? 'Visit Coffee with Dr. Rakhudu Website' : 'Website coming soon'}
            onClick={(e) => !divisionLinks.coffee.enabled && e.preventDefault()}
          >
            <FaGlobe className="text-xl" />
            {divisionLinks.coffee.enabled ? 'Visit Website' : 'Coming Soon'}
            {divisionLinks.coffee.enabled && <FaExternalLinkAlt className="text-sm" />}
          </Link>
        </div>
      </section>
      ...
      <section className="mb-12 bg-gray-50 p-6 rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          ...
          <Link
            ...
            title={divisionLinks.tvei.enabled ? 'Visit Village Economy Indaba Website' : 'Website coming soon'}
            onClick={(e) => !divisionLinks.tvei.enabled && e.preventDefault()}
          >
            <FaGlobe className="text-xl" />
            {divisionLinks.tvei.enabled ? 'Visit Website' : 'Coming Soon'}
            {divisionLinks.tvei.enabled && <FaExternalLinkAlt className="text-sm" />}
          </Link>
        </div>
      </section>
...
<section className="mb-12 bg-gray-50 p-6 rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          ...
          <Link
            ...
            title={divisionLinks.businessSchool.enabled ? 'Visit Business School Website' : 'Website coming soon'}
            onClick={(e) => !divisionLinks.businessSchool.enabled && e.preventDefault()}
          >
            <FaGlobe className="text-xl" />
            {divisionLinks.businessSchool.enabled ? 'Visit Website' : 'Coming Soon'}
            {divisionLinks.businessSchool.enabled && <FaExternalLinkAlt className="text-sm" />}
          </Link>
        </div>
      </section>
