        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link to="/krf-website/about" className="hover:text-gold">About</Link></li>
              <li><Link to="/krf-website/programs" className="hover:text-gold">Programmes</Link></li>
              <li><Link to="/krf-website/milestones" className="hover:text-gold">Milestones</Link></li>
              <li><Link to="/krf-website/impact" className="hover:text-gold">Impact</Link></li>
              <li><Link to="/krf-website/approach" className="hover:text-gold">Our Approach</Link></li>
              <li><Link to="/krf-website/contact" className="hover:text-gold">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 flex gap-6 text-sm">
              <a href="https://www.facebook.com/profile.php?id=100064528696915" target="_blank" rel="noreferrer" className="hover:text-gold">Facebook</a>
              <a href="https://www.linkedin.com/company/koketso-rakhudu-foundation/" target="_blank" rel="noreferrer" className="hover:text-gold">LinkedIn</a>
              <a href="https://www.instagram.com/koketsorakhudu_foundation/" target="_blank" rel="noreferrer" className="hover:text-gold">Instagram</a>
            </div>
          </div>
        </div>
