  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-4 md:px-8 text-center text-white">
        ...
        <div className="mt-12 mb-24 md:mb-0 flex flex-wrap justify-center gap-4 animate-fade-in-up animation-delay-400">
          <a
            href="/programs"
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-4 md:bottom-8 left-0 right-0 flex flex-col items-center gap-2 animate-bounce">
