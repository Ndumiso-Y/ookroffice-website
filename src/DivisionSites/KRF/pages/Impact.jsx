...
export default function Impact() {
  ...
  // Using centralized asset path helper for cleaner, more maintainable code
  const bootCampImages = generateGalleryImages('krf', '5DayBootCamp', 'IMG-20251028-WA00', 65, 11)

  const graduationImages = generateGalleryImages('krf', 'Graduation', 'IMG-20251028-WA00', 8, 45)

  const inductionImages = generateGalleryImages('krf', 'InductionDay', 'IMG-20251028-WA00', 53, 12)
