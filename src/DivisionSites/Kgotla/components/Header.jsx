...
// Import logo directly (bundled with webpack like Coffee division)
import KgotlhaLogoImg from '../assets/KgotlhaLogo.png';
...
const Header = () => {
  ...
  const navLinks = [
    ...
    { to: `${basePath}/heritage`, label: "Heritage" },
    { to: `${basePath}/events`, label: "Events" },
    // { to: `${basePath}/notices`, label: "Notices" },
  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 flex justify-between items-center transition-all duration-300">
        ...
        {/* Desktop Nav */}
        <ul className="hidden md:flex space-x-6 items-center font-medium text-[#1B5538] text-sm">
